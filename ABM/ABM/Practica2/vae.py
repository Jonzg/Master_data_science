...
def vae_lower_bound(gen_params, rec_params, data):
    ...
    # Evalua la ecuacion 14, hacemos una media respecto de todos los puntos en el minibatch

    # Podemos poner un breakpoint aqui:
...
if __name__ == '__main__':
    ...
    # Tenemos la funcion save_images para guardar las funciones en el disco.
